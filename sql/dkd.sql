...
CREATE TABLE `tb_vendout_running` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=1665296081440129026 DEFAULT CHARSET=utf8mb4 COMMENT='出货流水';
...
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COMMENT='合作商订单汇总表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COMMENT='设备表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_task_collect` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8mb4 COMMENT='工单按日统计表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB AUTO_INCREMENT=5209 DEFAULT CHARSET=utf8mb4 COMMENT='售货机货道表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COMMENT='按月统计各公司销售情况表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='策略表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_task_details` (
  ...
  `channel_code` VARCHAR(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '货道编号',
  `expect_capacity` INT NOT NULL DEFAULT '0' COMMENT '补货期望容量',
  `sku_id` BIGINT DEFAULT NULL COMMENT '商品Id',
  `sku_name` VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `sku_image` VARCHAR(500) CHARACTER SET utf8mb4 DEFAULT NULL,
...
) ENGINE=INNODB AUTO_INCREMENT=3770 DEFAULT CHARSET=utf8mb4 COMMENT='工单详情，只有补货工单才有';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_job` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='自动补货任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='设备类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_task` (
  ...
  `task_code` VARCHAR(40) CHARACTER SET utf8mb4 NOT NULL COMMENT '工单编号',
  `task_status` INT DEFAULT NULL COMMENT '工单状态',
  `create_type` INT DEFAULT NULL COMMENT '创建类型 0：自动 1：手动',
  `inner_code` VARCHAR(15) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '售货机编码',
  `user_id` INT DEFAULT NULL COMMENT '执行人id',
  `user_name` VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '执行人名称',
  `region_id` BIGINT DEFAULT NULL COMMENT '所属区域Id',
  `desc` VARCHAR(200) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '备注',
...
) ENGINE=INNODB AUTO_INCREMENT=544 DEFAULT CHARSET=utf8mb4 COMMENT='工单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=INNODB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='商品类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_order` (
  ...
  `pay_type` VARCHAR(10) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '支付类型，1支付宝 2微信',
...
) ENGINE=INNODB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='工单角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_task_type` (
  ...
  `type_name` VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '类型名称',
...
) ENGINE=INNODB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COMMENT='工单员工表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
SELECT COUNT(*) FROM information_schema.tables WHERE table_schema='dkd';